...
A studio portfolio site for **dumbbasss studio**, migrated from a static HTML/CSS/JS legacy build into a modern **Next.js 16** application using **TypeScript**, **TailwindCSS v4**, **GSAP**, and **Framer Motion**.
...
│   │   └── ScrollReveal.tsx # 🤖 AI — GSAP ScrollTrigger reveal
│   ├── consultation/
...
└── utils/
    ...
    └── kinetic-type.ts      # 🤖 AI — Ported Verlet physics engine
```
...
- `src/components/animations/ScrollReveal.tsx` — GSAP scroll reveal
...
- `src/utils/kinetic-type.ts` — Physics engine
