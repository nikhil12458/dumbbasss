...
function StepItem({
  ...
  return (
    ...
    >
      ...
      <div>
        <h2 className="font-display text-[clamp(28px,4vw,40px)] font-bold tracking-[-0.01em] mb-[16px]">
          {step.title}
        </h2>
        <p className="text-[16px] md:text-[18px] text-[var(--ink-soft)] leading-[1.6] max-w-[48ch]">
          {step.desc}
        </p>
      </div>
      <div className="font-mono text-[11.5px] text-[var(--ink-faint)] leading-[1.7] pt-[20px] border-t border-dashed border-[var(--line-strong)] mt-[24px] max-w-[48ch]">
        <span className="text-[var(--ink-soft)] block mb-[4px] uppercase tracking-[0.06em] text-[10px]">
          Output
        </span>
        {step.output}
      </div>
